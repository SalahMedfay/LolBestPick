...
/**
 * @ORM\Entity(repositoryClass="App\Repository\VsRepository")
 * @ORM\Table(uniqueConstraints={@ORM\UniqueConstraint(name="vs_idx", columns={"first_champion_id", "second_champion_id"})})
 */
class Vs
{
    /**
